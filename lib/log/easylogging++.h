...
#ifndef CUSTUM_EDITOR_JAYDUK
#define CUSTUM_EDITOR_JAYDUK
...
#define WAR LOG(WARNING)
#define TRA LOG(TRACE)
#define DBG LOG(DEBUG)
#define FAT LOG(FATAL)
